...
export const HiptzoChatContext = createContext();

const gun = Gun(['https://hiptzochat-gun-node.herokuapp.com/']);
...
export const HiptzoChatProvider = ({ children }) => {
